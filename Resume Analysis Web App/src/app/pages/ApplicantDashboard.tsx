              ...
              <div className="grid md:grid-cols-3 gap-4">
                {templates.map((template) => {
                  ...
                  return (
                    <Card
                      key={template.id}
                      className="cursor-pointer hover:shadow-xl transition-all transform hover:scale-105 border-gray-200 shadow-md"
                    ...
                    >
                      ...
                      <CardContent>
                        <Button className="w-full bg-emerald-500 hover:bg-emerald-600">Use Template</Button>
                      </CardContent>
                    </Card>
                  );
                })}
